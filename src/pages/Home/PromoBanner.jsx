    ...
    return (
        <div className="bg-black">
            <div className="relative">
                ...
                <div className="absolute top-[50%] -translate-y-[50%] px-6">
                    <h3 className="leading-[1.2] heading text-white text-2xl md:text-[50px] mb-2 font-extrabold w-[80%] lg:w-[58%]">HITTA RÄTT ELEKTRONIK FÖR DIN LIVSSTIL</h3>
